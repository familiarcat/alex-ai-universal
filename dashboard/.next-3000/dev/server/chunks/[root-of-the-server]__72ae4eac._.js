...
"[project]/dashboard/app/api/favicon/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ function generateFaviconSVG(status) {
    ...
    const pulseAnimation = status.level === 'optimal' || status.level === 'good' ? `<animate attributeName="opacity" values="1;0.5;1" dur="2s" repeatCount="indefinite"/>` : '';
...
async function GET(request) {
    try {
        ...
        return new __TURBOPACK__imported__module__$5b$project$5d2f$dashboard$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"](svg, {
            headers: {
        ...
        return new __TURBOPACK__imported__module__$5b$project$5d2f$dashboard$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"](defaultSVG, {
            headers: {
                'Content-Type': 'image/svg+xml',
...
//# sourceMappingURL=%5Broot-of-the-server%5D__72ae4eac._.js.map