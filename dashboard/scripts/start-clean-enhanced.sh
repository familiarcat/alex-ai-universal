#!/bin/bash
# Clean Enhanced Alex AI Dashboard
# Starts with crew intelligence and proper syntax

set -e

echo "🖖 Alex AI Enhanced Dashboard - Clean Start"
echo "=========================================="
...
# Create clean enhanced server
cat > clean-enhanced-server.js << 'EOF'
...
echo "✅ Clean enhanced server created"

# Start the clean enhanced server
echo "🚀 Starting Alex AI Clean Enhanced Dashboard server..."
echo ""
echo "🖖 Alex AI Clean Enhanced Dashboard is now running!"
echo "=================================================="
echo "📊 Dashboard URL: http://localhost:${PORT}"
echo "⏰ Federation Time: Immediate (clean enhanced server)"
echo "🔄 Press Ctrl+C to stop the server"
echo ""

node clean-enhanced-server.js
