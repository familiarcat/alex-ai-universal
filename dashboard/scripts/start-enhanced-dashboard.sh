#!/bin/bash
# Enhanced Alex AI Dashboard with Crew Details
# Includes personas, skills, roles, LLM agents, and Supabase memories

set -e

echo "🖖 Alex AI Enhanced Dashboard - Crew Intelligence"
echo "================================================"
...
# Build the dashboard
echo "🔨 Building enhanced dashboard..."
npm run build
echo "✅ Dashboard built successfully"

# Create enhanced server with crew intelligence
echo "📦 Creating enhanced server with crew details..."
cat > server.js << EOF
...
// Enhanced crew data with personas, skills, roles, and memories
const crewData = {
...
echo "✅ Enhanced server created with crew intelligence"
