...
exports.N8NWorkflowCLI = void 0;
const crew_workflow_updater_1 = require("./crew-workflow-updater");
class N8NWorkflowCLI {
    constructor() {
        ...
        this.workflowUpdater = new crew_workflow_updater_1.CrewWorkflowUpdater(this.n8nCredentials, this.supabaseConfig);
    }
    /**
    ...
    initializeCommands(program) {
        ...
        n8nCommand
            ...
            .action(async (crewMember, options) => {
            try {
        ...
        n8nCommand
            ...
            try {
                ...
                const memories = await this.workflowUpdater.retrieveCrewMemories(crewMember, options.query);
     ...
     */
    generateMockReportForCrewMember(crewMember) {
        const baseReport = {
            crewMember,
...
exports.N8NWorkflowCLI = N8NWorkflowCLI;
//# sourceMappingURL=n8n-workflow-cli.js.map