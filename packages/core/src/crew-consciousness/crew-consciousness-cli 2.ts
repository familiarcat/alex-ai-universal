...
import { CrewConsciousnessWorkflow, ProjectAnalysisRequest, CrewConsciousnessSession } from './crew-consciousness-workflow';

export class CrewConsciousnessCLI {
  private workflow: CrewConsciousnessWorkflow;
  ...
  constructor() {
    ...
    this.workflow = new CrewConsciousnessWorkflow(n8nCreds, supabaseConf);
  }

  public initializeCommands(program: Command): void {
    ...
    consciousnessCommand
      ...
      .action(async (sessionId: string, crewMember: string) => {
        try {
