...
exports.StealthScrapingService = void 0;
class StealthScrapingService {
     ...
     */
    async scrapeWithPuppeteer(job, puppeteer) {
     ...
     */
    getScrapingUrl(source, searchTerm, location) {
     ...
     */
    async extractJobData(page, source) {
...
exports.StealthScrapingService = StealthScrapingService;
//# sourceMappingURL=stealth-scraping-service.js.map