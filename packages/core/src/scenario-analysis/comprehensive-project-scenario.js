...
class ComprehensiveProjectScenarioAnalyzer {
     ...
     */
    async generateCrewContributions(step) {
        const crewMembers = [
     ...
     */
    async generateCrewMemberContribution(crewMember, step) {
        const contributions = {
            'Captain Picard': {
     ...
     */
    async generateCrewLearningAnalysis() {
     ...
     */
    async generateCrewMemberLearning(crewMember) {
        const learning = {
            crewMember,
            projectInsights: [],
            technicalLearnings: [],
     ...
     */
    async storeRAGMemory(crewMember, type, content) {
...
//# sourceMappingURL=comprehensive-project-scenario.js.map