  ...
  try {
    ...
    for (const workflow of crewWorkflows) {
      try {
        ...
        await page.goto(workflowUrl, { waitUntil: 'networkidle2', timeout: 30000 });
        await sleep(2000);
        ...
        await page.screenshot({ path: `/tmp/n8n-toggle-failed-${workflow.id}.png` });
        log.info(`      📸 Error screenshot: /tmp/n8n-toggle-failed-${workflow.id}.png`);
      }
